  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        custom: "bg-gradient-to-b from-[#049DC8] to-[#0082B5] text-white shadow-[0px_2px_6px_rgba(8,140,193,0.32)] hover:shadow-[0px_4px_12px_rgba(8,140,193,0.4)] hover:from-[#049DC8]/90 hover:to-[#0082B5]/90 active:scale-95",
        destructive:
      ...
      size: {
        ...
        custom: "h-9 px-5 py-2 gap-2 min-w-[82px] w-full max-w-[400px] flex-none",
        "outline-lg": "h-9 px-5 py-2 gap-2 min-w-[82px] w-[82px] flex-none",
        "subtle-lg": "h-9 px-5 py-2 gap-2 min-w-[82px] w-[82px] flex-none",
        icon: "size-9",
        "icon-sm": "size-8",
        "icon-lg": "size-10",
      },
